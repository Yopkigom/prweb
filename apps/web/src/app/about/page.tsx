...
const OVERVIEW = [
  ...
  },
  {
    ...
    stats: [
      ...
      { value: "4.3", unit: "/5.0", label: "사용자 평점" },
...
const SUMMARY = [
  ...
  {
    label: "AI 제품 서빙",
    text: "광고 소재 생성 서비스의 AI 생성/서빙 담당. FastAPI 백엔드, AI 엔진, React 프론트엔드를 OpenAPI 계약 하나로 결합, 광고 카피 가드레일 위반 0건, 생성 지연 p50 24.05초",
  },
  {
    label: "팀 리딩",
    text: "소셜 아바타 앱 개발팀장 3년 4개월. 개발 4명으로 4개월 만에 프로토타입, 1년 만에 오픈 베타. 누적 다운로드 30만, 사용자 평점 4.3",
  },
  {
    label: "테크리드",
...
const INTRO = [
  {
    label: "암묵지를 명시지로",
    text: "기획 내용을 확인하고 구현 가능성을 세부 항목으로 점검해 일정으로 바꾸는 것이 시니어의 역할이고, 그것이 암묵지를 명시지로 바꾸는 경력자의 힘이라고 생각합니다. 제한된 자원 안에서 앱을 돌아가게 하려고 써 온 방법을 일루니에서는 팀 4명의 개발 절차로, 지난 8월 두 팀을 동시에 맡았을 때는 사람과 코드 에이전트가 함께 읽는 저장소 규칙으로 적었습니다.",
  },
  {
    label: "16년, 같은 문제",
  ...
  {
    label: "온디바이스 AI",
    text: "일루니에서 AI 아바타 생성 서비스를 3년 넘게 만들었고, 뉴냅스에서는 제가 만든 실시간 녹음 모듈이 AI 팀의 음성 분석 모델로 넘어갔습니다. 두 곳 모두에서 모델을 쓰는 쪽에 있으면서 모델 자체를 다루지 못하는 한계를 느꼈고, 그 부분을 메우려고 7개월 AI 엔지니어 과정을 선택했습니다. 온디바이스 AI는 제가 16년 동안 풀어 온 것과 같은 문제였습니다. 의료영상 분류 모델을 세 가지 포맷으로 뽑아 같은 테스트셋으로 비교하고, 검증 정확도가 가장 높은 쪽 대신 위음성이 0인 쪽을 골랐습니다. 과정 밖에서는 llama.cpp를 Unity에 직접 붙여 Galaxy S25에서 문서 질의응답 앱을 돌렸습니다.",
  },
  {
    label: "두 팀 테크리드",
...
const CAREER = [
  {
    ...
    items: [
      ...
      "누적 다운로드 30만, 사용자 평점 4.3 / 5.0, 주요 업데이트와 비정기 핫픽스 운영",
      ...
      <section className={SHEET_CLASS}>
        ...
        <div className={SHEET_HEAD_CLASS}>
          ...
          <p className="text-sm leading-relaxed sm:text-right">
            <b>실시간 클라이언트 16년, AI 제품 개발 엔지니어.</b>
            <br />
            같은 문제를 16년째 풀고 있습니다.
          </p>
        </div>
